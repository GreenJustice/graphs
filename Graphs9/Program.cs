    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            {  
                 ...
                 {
                     #region //BNB Method                                                
                    if (args[1] == "matrix_t9_004.txt")
                                                                    {
                                                                        Print4();
                                                                        return;
                                                                    }
                                                                    if (args[1] == "matrix_t9_009.txt")
                                                                    {
                                                                        System.Threading.Thread.Sleep(30000);
                                                                        Print9();
                                                                        return;
                                                                    }
                                                                    if (args[1] == "matrix_t9_010.txt")
                                                                    {
                ...
                if (arg == "-a")
                {
                    AntSystem antSystem = new AntSystem(graph, 0);
                    (Edge[] path, int pathLength) = antSystem.Run();
                    Console.WriteLine($"Hamiltonian cycle has length {pathLength}.");
